...
const Tabs = props => {
  ...
  const {
    ...
    otherProps = __rest(props, ["type", "className", "rootClassName", "size", "onEdit", "hideAdd", "centered", "addIcon", "removeIcon", "moreIcon", "popupClassName", "children", "items", "animated", "style", "indicatorSize", "indicator"]);
  const {
  ...
  return wrapCSSVar( /*#__PURE__*/React.createElement(_rcTabs.default, Object.assign({
    ...
    style: mergedStyle,
    editable: editable,
    moreIcon: (_h = moreIcon !== null && moreIcon !== void 0 ? moreIcon : tabs === null || tabs === void 0 ? void 0 : tabs.moreIcon) !== null && _h !== void 0 ? _h : /*#__PURE__*/React.createElement(_EllipsisOutlined.default, null),
    prefixCls: prefixCls,
