...
struct ClientOptions {
    ...
    #[clap(long, env = "LINERA_CLIENT_TOKIO_THREADS")]
...
enum NetCommand {
    ...
    Up {
        ...
        #[clap(long, default_value = "table_default")]
        table_name: String,
