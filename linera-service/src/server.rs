...
struct ServerContext {
    ...
    reset_on_incorrect_outcome: bool,
    #[cfg(with_metrics)]
...
impl ServerContext {
        ...
        S: Storage + Clone + Send + Sync + 'static,
    {
        ...
        .with_reset_on_incorrect_outcome(self.reset_on_incorrect_outcome)
...
enum ServerCommand {
    ...
    Run {
        ...
        /// blocks from scratch. Sends RevertConfirm to all known senders.
        #[arg(long, default_value_t = false)]
        reset_on_incorrect_outcome: bool,
