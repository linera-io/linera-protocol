...
pub struct BenchmarkCommand {
    ...
    /// If true, will close the chains after the benchmark is finished. Keep in mind that
    ...
    /// For how long to run the benchmark for. If not provided, the benchmark will run until
    /// it is interrupted.
    #[arg(long)]
