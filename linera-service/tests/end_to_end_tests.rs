...
#[cfg(test_case(LocalNetConfig::new_test(Database::Service, Network::Grpc) ; "service_grpc"))]
...
#[cfg(test_case(LocalNetConfig::new_test(Database::Service, Network::Grpc) ; "fungible" ; "service_grpc"))]
#[cfg(test_case(LocalNetConfig::new_test(Database::Service, Network::Grpc) ; "native-fungible" ; "native_service_grpc"))]
...
#[cfg(test_case(LocalNetConfig::new_test(Database::Service, Network::Grpc) ; "service_grpc"))]
#[cfg(test_case(LocalNetConfig::new_test(Database::Service, Network::Tcp) ; "service_tcp"))]
#[cfg_attr(feature = "rocksdb", test_case(LocalNetConfig::new_test(Database::RocksDb, Network::Grpc) ; "rocksdb_grpc"))]
#[cfg_attr(feature = "scylladb", test_case(LocalNetConfig::new_test(Database::ScyllaDb, Network::Grpc) ; "scylladb_grpc"))]
#[cfg_attr(feature = "aws", test_case(LocalNetConfig::new_test(Database::DynamoDb, Network::Grpc) ; "aws_grpc"))]
