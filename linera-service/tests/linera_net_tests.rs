...
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(true) ; "remote_net_grpc"))]
...
#[cfg_attr(feature = "dynamodb", test_case(LocalNetConfig::new_test(Database::DynamoDb, Network::Grpc) ; "aws_grpc"))]
#[cfg_attr(feature = "kubernetes", test_case(SharedLocalKubernetesNetTestingConfig::new(Network::Grpc, BuildArg::Build) ; "kubernetes_grpc"))]
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(false) ; "remote_net_grpc"))]
#[test_log::test(tokio::test)]
...
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(false), "fungible" ; "remote_net_grpc"))]
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(false), "native-fungible" ; "native_remote_net_grpc"))]
#[test_log::test(tokio::test)]
...
#[cfg_attr(feature = "kubernetes", test_case(SharedLocalKubernetesNetTestingConfig::new(Network::Grpc, BuildArg::Build), "fungible" ; "kubernetes_grpc"))]
#[cfg_attr(feature = "kubernetes", test_case(SharedLocalKubernetesNetTestingConfig::new(Network::Grpc, BuildArg::Build), "native-fungible" ; "native_kubernetes_grpc"))]
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(true), "fungible" ; "remote_net_grpc"))]
#[cfg_attr(feature = "remote-net", test_case(RemoteNetTestingConfig::new(true), "native-fungible" ; "native_remote_net_grpc"))]
#[test_log::test(tokio::test)]
