...
#[cfg(feature = "ethereum")]
#[test_case(SharedLocalNetConfig::new_test(Database::Service, Network::Grpc) ; "service_grpc")]
#[cfg_attr(feature = "scylladb", test_case(SharedLocalNetConfig::new_test(Database::ScyllaDb, Network::Grpc) ; "scylladb_grpc"))]
#[cfg_attr(feature = "dynamodb", test_case(SharedLocalNetConfig::new_test(Database::DynamoDb, Network::Grpc) ; "aws_grpc"))]
...
#[cfg_attr(feature = "dynamodb", test_case(SharedLocalNetConfig::new_test(Database::DynamoDb, Network::Grpc), "native-fungible" ; "native_aws_grpc"))]
...
// #[cfg_attr(feature = "remote_net", test_case(RemoteNetTestingConfig::new(None) ; "remote_net_grpc"))]
#[test_case(SharedLocalNetConfig::new_test(Database::Service, Network::Grpc) ; "service_grpc")]
// #[cfg_attr(feature = "rocksdb", test_case(SharedLocalNetConfig::new_test(Database::RocksDb, Network::Grpc) ; "rocksdb_grpc"))]
#[test_log::test(tokio::test)]
