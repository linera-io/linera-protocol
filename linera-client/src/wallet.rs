...
pub struct Wallet {
    ...
    pub unassigned_key_pairs: HashMap<Address, AccountSecretKey>,
...
impl Wallet {
    ...
    pub fn key_pair_for_owner(&self, owner: &Address) -> Option<AccountSecretKey> {
        ...
        self.chains
            ...
            .find(|key_pair| Address::from(key_pair.public()) == *owner)
            .map(|key_pair| key_pair.copy())
    }
