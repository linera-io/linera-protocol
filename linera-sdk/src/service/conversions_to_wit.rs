...
use linera_base::{crypto::CryptoHash, identifiers::Address};
...
impl From<Address> for wit_service_api::Address {
    fn from(account_owner: Address) -> Self {
        match account_owner {
            Address::Address32(owner) => wit_service_api::Address::Address32(owner.into()),
        }
    }
}
