...
///
/// Use the `call_application` method generated by the [`linera_sdk::contract`] macro in order to
...
///
/// Use the `call_session` method generated by the [`linera_sdk::contract`] macro in order to
/// guarantee the state is up-to-date in reentrant calls.
