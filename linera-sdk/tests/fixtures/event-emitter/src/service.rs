...
pub struct EventEmitterService {
    state: Arc<EventEmitterState>,
    runtime: Arc<ServiceRuntime<Self>>,
}

linera_sdk::service!(EventEmitterService);

impl WithServiceAbi for EventEmitterService {
    type Abi = event_emitter::EventEmitterAbi;
}

impl Service for EventEmitterService {
    type Parameters = ();
