...
impl ChainOwnership {
    ...
    pub fn single_super(owner: Address) -> Self {
        ChainOwnership {
    ...
    pub fn single(owner: Address) -> Self {
        ChainOwnership {
    ...
    pub fn multiple(
        owners_and_weights: impl IntoIterator<Item = (Address, u64)>,
    ...
    pub fn with_regular_owner(mut self, owner: Address, weight: u64) -> Self {
    ...
    pub fn verify_owner(&self, owner: &Address) -> bool {
    ...
    pub fn all_owners(&self) -> impl Iterator<Item = &Address> {
...
mod tests {
    ...
    fn test_ownership_round_timeouts() {
        ...
        let super_owner = Address::from(super_pub_key);
        let pub_key = Secp256k1SecretKey::generate().public();
        let owner = Address::from(pub_key);
