...
```bash
(cd examples/non-fungible && cargo build --release --target wasm32-linera-chain)

MODULE_ID=$(linera publish-module \
    examples/target/wasm32-linera-chain/release/non_fungible_{contract,service}.wasm)
```
