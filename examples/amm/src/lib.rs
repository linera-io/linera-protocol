...
pub enum Operation {
    ...
    /// AccountOwner here is the user executing the Swap
    Swap {
        owner: AccountOwner,
        input_token_idx: u32,
        input_amount: Amount,
    ...
    /// AccountOwner here is the user adding liquidity, which currently can only
    /// be a chain owner
    AddLiquidity {
        owner: AccountOwner,
    ...
    /// AccountOwner here is the user removing liquidity, which currently can only
    /// be a chain owner
    RemoveLiquidity {
        owner: AccountOwner,
