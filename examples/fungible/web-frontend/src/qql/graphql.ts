...
export type MapFilters_AccountOwner_2fb690f5 = {
  keys?: InputMaybe<Array<Scalars['Address']['input']>>;
};
...
export type MapView_AccountOwner_Amount_Ea496e19 = {
  ...
  keys: Array<Scalars['Address']['output']>;
};
