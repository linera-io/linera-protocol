...
use linera_execution::{
    ...
    system::{
        Account, AdminOperation, Committees, Recipient, SystemChannel, SystemMessage,
        SystemOperation, UserData,
    },
...
async fn make_transfer_certificate_for_epoch<S>(
    ...
    let system_state = SystemExecutionState {
        ...
        committees: Committees([(epoch, committee.clone())].into_iter().collect()),
        ...
        HashedValue::new_confirmed(ExecutedBlock {
            block: Block {
                ...
                operations: vec![Operation::System(SystemOperation::OpenChain {
                    ownership: ChainOwnership::single(key_pair.public()),
                    epoch: Epoch::from(0),
                    committees: Committees(committees.clone()),
                    admin_id,
                })],
                previous_block_hash: None,
                height: BlockHeight::from(0),
            ...
            messages: vec![
                channel_outgoing_message(
                    ...
                    SystemMessage::SetCommittees {
                        epoch: Epoch::from(1),
                        committees: Committees(committees2.clone()),
                    },
                ),
                direct_outgoing_message(
                    user_id,
        ...
        HashedValue::new_confirmed(ExecutedBlock {
            ...
            messages: vec![
                ...
                channel_outgoing_message(
                    ...
                    SystemMessage::SetCommittees {
                        epoch: Epoch::from(1),
                        committees: Committees(committees3.clone()),
                    },
                ),
            ],
            state_hash: make_state_hash(SystemExecutionState {
