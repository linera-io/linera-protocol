    ...
    B: StorageBuilder,
{
    ...
    let sender_account = Account {
        chain_id: ChainId::root(1),
        owner: AccountOwner::Address32(sender.0),
    };
    ...
    let recipient_account = Account {
        chain_id: ChainId::root(2),
        owner: AccountOwner::Address32(recipient.0),
    };
        ...
        vec![IncomingBundle {
            ...
            bundle: MessageBundle {
                ...
                messages: vec![Message::System(SystemMessage::Credit {
                    source: AccountOwner::Chain,
                    target: AccountOwner::Address32(sender.0),
    ...
    let certificate1 = make_transfer_certificate(
        ...
        &sender_key_pair,
        Some(sender),
        AccountOwner::Address32(sender.0),
    ...
    let certificate = make_transfer_certificate(
        ...
        &recipient_key_pair,
        Some(recipient),
        AccountOwner::Address32(recipient.0),
        Recipient::Burn,
        Amount::ONE,
        vec![
            IncomingBundle {
                ...
                bundle: MessageBundle {
                    ...
                    transaction_index: 0,
                    messages: vec![Message::System(SystemMessage::Credit {
                        source: AccountOwner::Address32(sender.0),
                        target: AccountOwner::Address32(recipient.0),
