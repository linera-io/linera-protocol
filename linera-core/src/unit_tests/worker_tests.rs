...
use linera_base::{
    ...
    data_types::*,
    identifiers::{Account, AccountOwner, ChainId, Destination, EventId, StreamId},
    ...
    B: StorageBuilder,
{
    ...
    let inbox = chain
        .inboxes
        .try_load_entry(&Origin::chain(chain_3))
        .await?
    ...
    B: StorageBuilder,
{
    ...
    let inbox = chain
        .inboxes
        .try_load_entry(&Origin::chain(chain_1))
        .await?
