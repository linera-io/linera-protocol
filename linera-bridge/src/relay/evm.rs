...
/// fit under the node's block gas limit — i.e. the node refused to
/// estimate because the work required more gas than a single block can
/// hold. Substring-matches on the node's error message; pinned to the
/// known wordings for anvil, geth, and reth as of writing.
