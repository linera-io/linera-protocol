...
<<<<<<< HEAD:linera-bridge/src/solidity/WrappedFungibleTypesV1.sol
...
>>>>>>> 22c1ee41d1 (Extract new committee rotation from an event, not operation (#6482)):linera-bridge/src/solidity/WrappedFungibleTypes.sol
