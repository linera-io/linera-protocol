...
#[library_benchmark]
#[bench::get_existing(setup_map_1000())]
...
#[library_benchmark]
#[bench::get_missing(setup_map_1000())]
...
#[library_benchmark]
#[bench::contains_key_1000(setup_map_1000())]
fn bench_map_view_contains_key(
    (rt, view): (Runtime, MapView<MemoryContext<()>, String, Vec<u8>>),
) {
    rt.block_on(async {
        for i in (0..1000).step_by(10) {
...
fn bench_map_view_pre_save(
    (_rt, view): (Runtime, MapView<MemoryContext<()>, String, Vec<u8>>),
) {
...
#[library_benchmark]
#[bench::front_from_1000(setup_queue_1000())]
...
#[library_benchmark]
#[bench::front_from_1000(setup_bucket_queue_1000())]
...
/// Index type with non-trivial serialization cost (from existing benchmark).
...
#[library_benchmark]
#[bench::get_set(setup_register_view())]
fn bench_register_view_get_set(
    (_rt, mut view): (Runtime, RegisterView<MemoryContext<()>, String>),
) {
    let val = view.get().clone();
    view.set(format!("{val}_modified"));
    black_box(view.get());
}
...
#[library_benchmark]
#[bench::load_all_in_memory(setup_populated_collection())]
...
#[library_benchmark]
#[bench::load_all_from_storage(setup_collection_from_storage())]
...
#[library_benchmark]
#[bench::indices(setup_populated_collection())]
