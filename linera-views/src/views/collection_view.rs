    ...
    W: View<C>,
{
    ...
    /// # use linera_views::views::collection_view::ByteCollectionView;
    ...
    W: View<C>,
{
    ...
    /// # tokio_test::block_on(async {
    /// # use linera_views::store::memory::{create_memory_context, MemoryContext};
    /// # use linera_views::views::collection_view::CollectionView;
    /// # use linera_views::views::register_view::RegisterView;
    /// # use crate::linera_views::view::View;
    /// # let context = create_memory_context();
    ...
    W: View<C>,
{
    ...
    /// # tokio_test::block_on(async {
    /// # use linera_views::store::memory::{create_memory_context, MemoryContext};
    /// # use linera_views::views::collection_view::CustomCollectionView;
    /// # use linera_views::views::register_view::RegisterView;
    /// # use crate::linera_views::view::View;
    /// # let context = create_memory_context();
