...
#[cfg(with_testing)]
impl DynamoDbStore {
    /// Creates a `DynamoDbStore` for testing purposes.
    pub async fn new_test_store() -> Result<Self, DynamoDbStoreError> {
        let database = DynamoDbDatabase::connect_test_namespace().await?;
