...
test('Applications mounting', () => {
  set_test_config().then(() => {
    mount(Applications, {
      props: {
        apps: [ {
          address: "aee928d4bf3880353b4a3cd9b6f88e6cc6e5ed050860abae439e7782e9b2dfe8020000000000000000000000aee928d4bf3880353b4a3cd9b6f88e6cc6e5ed050860abae439e7782e9b2dfe8040000000000000000000000",
