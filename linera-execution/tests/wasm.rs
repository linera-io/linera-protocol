...
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::Wasmer, 29_140, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::WasmerWithSanitizer, 29_445, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(feature = "wasmtime", test_case(WasmRuntime::Wasmtime, 29_445, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(feature = "wasmtime", test_case(WasmRuntime::WasmtimeWithSanitizer, 29_445, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
