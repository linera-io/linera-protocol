...
#[cfg_attr(with_wasmer, test_case(WasmRuntime::Wasmer, 54_193, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(with_wasmer, test_case(WasmRuntime::WasmerWithSanitizer, 54_589, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::Wasmtime, 54_589, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::WasmtimeWithSanitizer, 54_589, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
