    ...
    C::Extra: ExecutionRuntimeContext,
{
        ...
        match operation {
            ...
            CreateApplication {
                ...
                for required_application_id in required_application_ids {
                    txn_tracker.replay_oracle_response(OracleResponse::Blob(BlobId::new(
                        required_application_id.application_description_hash,
    ...
    pub async fn check_and_record_application_blob(
        ...
        self.check_and_record_bytecode_blobs(&application_id.bytecode_id, txn_tracker)
            .await?;
        ...
        let application_blob_id = BlobId::new(
            ...
            self.context()
                ...
                .await?,
            SystemExecutionError::BlobNotFoundOnRead(application_blob_id)
        );
