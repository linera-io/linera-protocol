...
pub enum WasmContract {
    ...
    #[cfg(feature = "wasmtime")]
    Wasmtime { contract: Arc<::wasmtime::Module> },
}
...
pub enum WasmService {
    #[cfg(feature = "wasmer")]
    Wasmer { service: Arc<::wasmer::Module> },
    #[cfg(feature = "wasmtime")]
    Wasmtime { service: Arc<::wasmtime::Module> },
}
