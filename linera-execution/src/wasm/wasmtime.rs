...
impl VmContractModule {
    /// Creates a new [`VmContractModule`] using Wasmtime with the provided bytecodes.
    pub async fn from_wasmtime(contract_bytecode: Bytecode) -> Result<Self, VmExecutionError> {
        ...
        Ok(VmContractModule::Wasmtime { module })
    }
}
...
impl VmServiceModule {
    /// Creates a new [`VmServiceModule`] using Wasmtime with the provided bytecodes.
    pub async fn from_wasmtime(service_bytecode: Bytecode) -> Result<Self, VmExecutionError> {
        ...
        Ok(VmServiceModule::Wasmtime { module })
    }
}
