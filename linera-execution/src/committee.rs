...
pub struct ValidatorName(pub Ed25519PublicKey);
...
impl<'de> Deserialize<'de> for ValidatorName {
        ...
        D: serde::de::Deserializer<'de>,
    {
        if deserializer.is_human_readable() {
            ...
            struct ValidatorNameDerived(Ed25519PublicKey);
...
impl std::str::FromStr for ValidatorName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(ValidatorName(Ed25519PublicKey::from_str(s)?))
    }
}
...
impl From<Ed25519PublicKey> for ValidatorName {
...
impl Committee {
    ...
    pub fn keys_and_weights(&self) -> impl Iterator<Item = (Ed25519PublicKey, u64)> + '_ {
        self.validators
            .iter()
