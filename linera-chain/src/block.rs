...
impl TryFrom<CertificateValue> for ConfirmedBlock {
    type Error = &'static str;

    fn try_from(value: CertificateValue) -> Result<Self, Self::Error> {
        match value {
            CertificateValue::ConfirmedBlock(confirmed) => Ok(confirmed),
