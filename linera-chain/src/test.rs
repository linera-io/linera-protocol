...
pub trait BlockTestExt: Sized {
    ...
    fn into_first_proposal(self, key_pair: &Ed25519SecretKey) -> BlockProposal {
    ...
    fn into_proposal_with_round(self, key_pair: &Ed25519SecretKey, round: Round) -> BlockProposal;
}
